...
void drawTexturedBoxF(float lowerX, float lowerY, float w, float h, float sL, float tL, float sH, float tH)
{
	glBegin(GL_QUADS);
	{
		glTexCoord2f( sL, tL );
...
void copyTexturedBoxF(float lowerX, float lowerY, float w, float h)
{
	glBegin(GL_QUADS);
	{
		glTexCoord2f( lowerX, lowerY );
		glVertex2f( lowerX , lowerY );
		
		glTexCoord2f( lowerX + w, lowerY );
		glVertex2f( lowerX + w, lowerY );
		
		glTexCoord2f( lowerX + w, lowerY + h );
		glVertex2f( lowerX + w, lowerY + h );
		
		glTexCoord2f( lowerX, lowerY + h );
		glVertex2f( lowerX, lowerY + h );
	}
	glEnd();
}
